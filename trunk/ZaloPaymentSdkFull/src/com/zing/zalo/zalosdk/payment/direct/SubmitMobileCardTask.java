...
class SubmitMobileCardTask implements PaymentTask {
	private final String _paymentUrl = "http://dev.telcos.credits.zaloapp.com/dbverify?";
	
	public MobileCardPaymentAdapter owner;
	String value;
	@Override
				...
				if (e.isRequire()) {
					...
					if (value.isEmpty()) {
						...
						try {
							...
							owner.showWarningIconInNUIContext(editText.getId());
...
//		}
		...
		sb.append("&" + owner.textView.getParam() + "=").append(owner.textView.getValue());
